        ...
        function toggleRowColor(radio) {
            ...
            row.classList.add('blue');
                ...
                function test(){
                        ...
                        document.getElementById('upCount').textContent = 'Up: ' + upCount+'   /15';
                        document.getElementById('downCount').textContent = 'Down: ' + downCount+'    /15';
                        document.getElementById('noCount').textContent = 'No: ' + noCount+'    /15';
                        document.getElementById('resault_inp').value ='Up: ' + upCount+'   /15 ---    ' + '   Down: ' + downCount+'    /15 ---   '+'    No: ' + noCount+'    /15  ';
                    }
